...
const IntialValuesHotelsDetails = ({ hotel, data }) => {
  return (
    <div className="border-b pb-8 flex gap-12 lg:flex-row flex-col">
      <div className="lg:w-1/4 w-full ">
        ...
        871543838!2d${hotel?.contactInfo?.address?.longitude}!3d${hotel?.contactInfo?.address?.latitude}!2m3!1f0!2f0!3f0!3
        ...
        <div className="flex gap-4 sm:flex-row flex-col">
          <div className="flex items-center md:w-[350px] w-full border border-gray-300 rounded-lg px-2 py-1">
            ...
            <div className="flex items-start flex-col w-full">
              ...
              <p className="text-black font-bold">
                {dayjs(hotel?.policy?.checkInTime, 'HH:mm').format('hh:mm A')} (
                {hotel?.timeZone?.id})
              </p>
            </div>
          </div>
          <div className="flex items-center md:w-[350px] w-full border border-gray-300 rounded-lg px-2 py-1">
            ...
            <div className="flex items-start flex-col w-full">
              ...
              <p className="text-black font-bold">
                {dayjs(hotel?.policy?.checkOutTime, 'HH:mm').format('hh:mm A')}{' '}
                ({hotel?.timeZone?.id})
              </p>
            </div>
          </div>
          <div className="flex items-center md:w-[350px] w-full border border-gray-300 rounded-lg px-2 py-1">
            ...
            <div className="flex items-start flex-col w-full">
              ...
              <p className="text-black font-bold">
                {data?.adult} Adults , {data?.childAges?.length} Child
              </p>
            </div>
          </div>
        </div>
...
export default IntialValuesHotelsDetails
