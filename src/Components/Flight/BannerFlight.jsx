...
import bannerHotel from '../../assets/Img/bannerFlights.png'
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        (!selectorRef2.current || !selectorRef2.current.contains(event.target))
      ) {
      ...
      <section className="relative h-full flex flex-col items-center justify-center text-center py-12 px-4">
        <div className="relative z-10 text-white max-w-8xl mx-auto">
          <h1 className="text-3xl md:text-6xl font-bold mt-16">
            Search for the Best <br /> Rental Flight Deals
          </h1>
                    ...
                    >
                      ...
                      <div className="mb-4 flex items-center justify-between">
                        ...
                        <input
                          ...
                          checked={children > 0}
                          onChange={(e) =>
                            e.target.checked ? addChild() : removeChild()
                          }
                        />
                      </div>
                    </div>
